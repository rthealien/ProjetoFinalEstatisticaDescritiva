...
O dataset filtrado com o curso de **Música(Licenciatura)** possui 3974 observações, destas foram identificados 773 registros com NA nas variáveis **QE_I01, QE_I02, QE_I08, QE_I21, QE_I23** e 1044 registros com NA nas variávaies **NT_GER, NT_OBJ_FG, NT_OBJ_CE**. Removemos estes registros e passamos a ter um dataset com 2753 observações.
